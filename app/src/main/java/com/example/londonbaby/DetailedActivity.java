...
public class DetailedActivity extends AppCompatActivity {
    ...
    String platform934 = "Αυτό το ταξίδι δεν έχει ηλικία, αφού όλοι κατά βάθος είμαστε παιδιά! Εάν πάλι δε νιώθεις έτσι, μια επίσκεψη στην Platform 9 3/4 βρίσκεται στον σταθμό του τρένου King’s Cross θα σε πείσει να περάσεις στο μαγικό κόσμο. Ο Harry Potter και η παρέα του σε περιμένουν για ένα ξεχωριστό tour στο studio της Warner Bros στο Watford για να σε μεταφέρουν για τα καλά στο Hogwards, να σου προσφέρουν μια μπύρα με τζίντζερ και να αγοράσεις μαγικά ραβδιά και άλλα souvenir.";

    String madison = "Πρόκειται για καταπληκτικό μπαρ-ρεστοράν στην κορυφή ενός μικρού ουρανοξύστη (1 New Change) δίπλα στον καθεδρικό ναό του Αγίου Παύλου.\n" + "\n" + "Υπέροχη θέα, ευγενέστατο προσωπικό με πάμπολλες επιλογές από καφέ και σνακ μέχρι κοκτέιλ και φαγητό που σίγουρα θα σας καλύψουν.\n" + "\n" + "Το καλοκαίρι είναι ιδανικά να καθίσετε έξω με φόντο τον υπέροχο τρούλο, ενώ συχνά προγραμματίζονται και προβολές ταινιών.";

    String fryersDelight = "Είναι ένα μαγαζί του Λονδίνου που φημίζεται για το καλύτερο FISH N CHIPS της πόλης. Το σίγουρο είναι πως αυτό το μαγαζί δεν είναι τουριστικό. Μάλιστα είναι στέκι λονδρέζων ταξιτζήδων.";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (place){
            ...
            case Platform934:
                toolBarLayout.setTitle(getResources().getString(R.string.platform934));
                toolBarLayout.setBackground(getDrawable(R.drawable.platform934));
                text = platform934;
            ...
            case Madison:
                toolBarLayout.setTitle(getResources().getString(R.string.madison));
                toolBarLayout.setBackground(getDrawable(R.drawable.madison));
                text = madison;
